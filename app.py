...
if st.session_state.user_role == "student":
    ...
    with col2:
        ...
        st.info(f"Kindly confirm the valid emails below: {', '.join(selected_emails)}")
        st.info(f"Kindly confirm the full names of all the valid emails below: {', '.join(selected_names)}")
